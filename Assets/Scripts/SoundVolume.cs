...
public class SoundVolume : MonoBehaviour
{
    ...
    public void SetMusictrackVolume()
    {
        ...
        mixer.SetFloat("musicVol", Mathf.Log10(0.001f+musicVolume.value) * 25);
    }
    public void SetoveralltrackVolume()
    {
        PlayerPrefs.SetFloat("overallVol", overallVolume.value);
        mixer.SetFloat("overallVol", Mathf.Log10(0.001f + overallVolume.value) * 25);
    }
    public void SetsfxtrackVolume()
    {
        PlayerPrefs.SetFloat("sfxVol", sfxVolume.value);
        mixer.SetFloat("sfxVol", Mathf.Log10(0.001f + sfxVolume.value) * 25);
    }
